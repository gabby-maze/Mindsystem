...
export default function CoursesideDashboard() {
  ...
  return (
    <Layout>
      <div style={{ color: "#fff", backgroundColor: "#0a0a0a" }}>
        ...
        <section className="flex flex-col items-center text-center px-6 pt-16 pb-12">
          ...
          <h1
            className="text-4xl md:text-6xl leading-tight mb-6 max-w-3xl"
        ...
        <section className="px-6 py-16 border-t border-white/10 max-w-3xl mx-auto w-full">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">None of that is random.</p>
          <p className="text-gray-300 mb-6 leading-relaxed">
          ...
          <p className="text-xl font-semibold" style={{ color: TEAL }}>That ends here.</p>
        </section>
        ...
        <section className="px-6 py-16 border-t border-white/10 max-w-5xl mx-auto w-full">
          <h2
          ...
          <p className="text-center text-gray-400 mb-14 max-w-xl mx-auto leading-relaxed">
        ...
        <section className="px-6 py-16 border-t border-white/10 max-w-3xl mx-auto w-full">
          ...
          <p className="text-xs uppercase tracking-widest font-semibold mb-6" style={{ color: TEAL }}>
            This is for you if:
          </p>
        ...
        <section className="px-6 py-16 border-t border-white/10 max-w-3xl mx-auto w-full">
          <p className="text-xs uppercase tracking-widest font-semibold mb-6 text-gray-500">
