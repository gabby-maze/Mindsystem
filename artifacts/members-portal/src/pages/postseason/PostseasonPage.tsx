      ...
      <Layout>
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6">
          ...
          <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: "0.95rem", color: "rgba(255,255,255,0.4)", maxWidth: "400px" }}>
            The Postseason guide is available on Courtside Conversations and above.
          </p>
        </div>
      </Layout>
    );
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="text-center mb-10">
          ...
          <p style={{
            ...
            The data you collect now is your advantage next season.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <PdfSlideViewer pdfUrl={`${import.meta.env.BASE_URL}postseason-guide.pdf`} />
        </div>
